...
The Modoo administration was briefly seen during the `website support`_ section.
...
Modoo provides technical models, which don't directly fulfill business needs
