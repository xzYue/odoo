...
Run the server and update the theme (``./modoo.py -u dummy_theme``), then
...
Put your images in ``modoo/addons/theme_dummy/static/img``, or in sub-folders
if needed. Open :file:`modoo/addons/theme_dummy/static/style/custom.less`, add
these lines
