...
For simplicity and developer-friendliness Modoo web provides a class
...
The ``HomePage`` widget is used by Modoo Web and managed automatically.
...
user to modify it can be useful, but most fields in Modoo also allow editing.
