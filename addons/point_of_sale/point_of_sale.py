...
class pos_config(osv.osv):
    ...
    _columns = {
        ...
        'iface_self_checkout' : fields.boolean('Self Checkout Mode', # FIXME : this field is obsolete
             help="Check this if this point of sale should open by default in a self checkout mode. If unchecked, Modoo uses the normal cashier mode by default."),
        ...
        'sequence_id' : fields.many2one('ir.sequence', 'Order IDs Sequence', readonly=True,
            help="This sequence is automatically created by Modoo but you can change it "\
