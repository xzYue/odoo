...
class About(unohelper.Base, XJobExecutor):
    def __init__(self, ctx):
        ...
        self.version = "0.1"
        self.win = DBModalDialog(60, 50, 175, 115, "About Modoo Report Designer")
