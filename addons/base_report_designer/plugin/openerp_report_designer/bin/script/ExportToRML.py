...
class ExportToRML( unohelper.Base, XJobExecutor ):
    def __init__(self, ctx):
        ...
        if docinfo.getUserFieldValue(2) == "":
            ErrorDialog("Please Save this file on server","Use Send To Server Option in Modoo Report Menu","Error")
            exit(1)
    ...
    def GetAFileName(self):
        ...
        oFileDialog.appendFilter("Modoo Report File Save To ....","*.rml")
