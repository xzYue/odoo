...
The Modoo <a href="https://www.modoo.com/page/accounting">Open Source Accounting</a> app allows a better way to
...
in one place. Modoo's user interface is designed with productivity in mind.
...
accounting; Modoo has all the features you need to sustain all your business
activities.

Scale With Your Organization
----------------------------

Modoo supports multiple currencies, multiple users with different access rights,
