...
class config(osv.Model):
    ...
    def copy_doc(self, cr, uid, res_id, template_id, name_gdocs, res_model, context=None):
        ...
        if content.get('alternateLink'):
            ...
            request_url = "https://www.googleapis.com/drive/v2/files/%s/permissions?emailMessage=This+is+a+drive+file+created+by+Modoo&sendNotificationEmails=false&access_token=%s" % (key, access_token)
