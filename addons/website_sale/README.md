...
Modoo is an <a href="https://www.modoo.com/page/e-commerce">Open Source eCommerce</a>
...
Modoo's unique *'edit inline'* and building blocks approach makes product pages
...
Modoo's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Modoo's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Modoo marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Modoo proposes
...
SEO tools are ready to use, with no configuration required. Modoo suggests
...
Create new landing pages easily with the Modoo inline edition feature. Send
...
Benefit from the power of Modoo, in your online store: a powerfull tax engine,
...
Everything is integrated with Modoo. No pain, real time.
