...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.modoo.com/page/contactus"
...
; English
LangString DESC_OpenERP_Server ${LANG_ENGLISH} "Install the Modoo Server with all the Modoo standard modules."
LangString DESC_PostgreSQL ${LANG_ENGLISH} "Install the PostgreSQL RDBMS used by Modoo."
LangString DESC_FinishPage_Link ${LANG_ENGLISH} "Contact Modoo for Partnership and/or Support"
LangString DESC_AtLeastOneComponent ${LANG_ENGLISH} "You have to choose at least one component"
LangString DESC_CanNotInstallPostgreSQL ${LANG_ENGLISH} "You can not install the PostgreSQL database without the Modoo Server"
...
LangString TITLE_OpenERP_Server ${LANG_ENGLISH} "Modoo Server"
LangString TITLE_PostgreSQL ${LANG_ENGLISH} "PostgreSQL Database"
LangString DESC_FinishPageText ${LANG_ENGLISH} "Start Modoo"

; French
LangString DESC_OpenERP_Server ${LANG_FRENCH} "Installation du Serveur Modoo avec tous les modules Modoo standards."
LangString DESC_PostgreSQL ${LANG_FRENCH} "Installation de la base de donn?es PostgreSQL utilis?e par Modoo."
LangString DESC_FinishPage_Link ${LANG_FRENCH} "Contactez Modoo pour un Partenariat et/ou du Support"
LangString DESC_AtLeastOneComponent ${LANG_FRENCH} "Vous devez choisir au moins un composant"
LangString DESC_CanNotInstallPostgreSQL ${LANG_FRENCH} "Vous ne pouvez pas installer la base de donn?es PostgreSQL sans le serveur Modoo"
...
LangString TITLE_OpenERP_Server ${LANG_FRENCH} "Serveur Modoo"
LangString TITLE_PostgreSQL ${LANG_FRENCH} "Installation du serveur de base de donn?es PostgreSQL"
LangString DESC_FinishPageText ${LANG_FRENCH} "Démarrer Modoo"
...
# If there is a previous install of the OpenERP Server, keep the login/password from the config file
    ...
    nsExec::Exec "net stop modoo-server-8.0"
    sleep 2

    nsExec::Exec "net start modoo-server-8.0"
    sleep 2
...
;    WriteRegDWORD HKLM     "${UNINSTALL_REGISTRY_KEY}" "VersionMinor" "${REVISION_VERSION}"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpLink" "support@modoo.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpTelephone" "+32.81.81.37.00"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://www.modoo.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "Contact" "sales@modoo.com"
...
Section "Uninstall"
    ...
    nsExec::Exec "net stop modoo-server-8.0"
    nsExec::Exec "sc delete modoo-server-8.0"
    sleep 2
