...
class ir_sequence(openerp.osv.osv.osv):
    ...
    _columns = {
        ...
        'padding' : openerp.osv.fields.integer('Number Padding', required=True, help="Modoo will automatically adds some '0' on the left of the 'Next Number' to get the required padding size."),
