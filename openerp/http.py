...
class WebRequest(object):
    """ Parent class for all Modoo Web request types, mostly deals with
    ...
    def _handle_exception(self, exception):
        ...
        try:
            ...
            if isinstance(exception, AuthenticationError):
                error['code'] = 100
                error['message'] = "Modoo Session Invalid"
            if isinstance(exception, SessionExpiredException):
                error['code'] = 100
                error['message'] = "Modoo Session Expired"
